...
###########################################################
video_urls = {
    "L01_2_configure_the_model": [
        "https://media.uwex.edu/content/ds/ds776/ds776_l01_2_configure_the_model/",
        "https://share.descript.com/view/ylXSAeD5IaA"
    ],
    "L01_2_evaluate_the_model": [
        "https://media.uwex.edu/content/ds/ds776/ds776_l01_2_evaluate_the_model/",
        "https://share.descript.com/view/e6HmrPxo2oR"
    ],
    "L01_2_make_predictions": [
        "https://media.uwex.edu/content/ds/ds776/ds776_l01_2_make_the_predictions/",
        "https://share.descript.com/view/P25g0EleiQH"
    ],
    "L01_2_prepare_the_data": [
        "https://media.uwex.edu/content/ds/ds776/ds776_l01_2_prepare_the_data/",
        "https://share.descript.com/view/6mXJjH6NFJ8"
    ],
    "L01_2_train_the_model": [
        "https://media.uwex.edu/content/ds/ds776/ds776_l01_2_train_the_model/",
        "https://share.descript.com/view/P5XcxjuNC2u"
    ],
    "L01_3_classification_summary": [
        "https://media.uwex.edu/content/ds/ds776/ds776_l01_3_classification_summary",
        "https://share.descript.com/view/PBBUam1baoL"
    ],
    "L02_1_MNIST_Dataset": [
        "",
        "https://share.descript.com/view/PBBUam1baoL"
    ],
    "L02_1_MNIST_FC_Model": [
        "",
        "https://share.descript.com/view/M9TdvAP64pa"
    ],
    "L02_1_MNIST_FC_Evaluation": [
        "",
        "https://share.descript.com/view/U8URO7JMabR"
    ],
    "L02_2_Convolutional_Formulas": [
        "",
        "https://share.descript.com/view/iDFKKdBxz74"
    ],
    "L02_3_MNIST_CNN_LeNet5": [
        "",
        "https://share.descript.com/view/VC91dl57Z4c"
    ],
    "L02_3_MNIST_CNN_Feature_Maps": [
        "",
        "https://share.descript.com/view/6kSelZDZNeE"
    ],
    "L02_3_MNIST_CNN_LeNet5_Rev": [
        "",
        "https://share.descript.com/view/HVt2kMmt2ej"
    ],
    "L03_1_SimpleCNN_Walkthrough": [
        "",
        "https://share.descript.com/view/R0LNClopegz"
    ],
    "L03_1_Learning_Rates": [
        "",
        "https://share.descript.com/view/IrBJVXD3av8"
    ],
    "L03_1_Optimizers": [
        "",
        "https://share.descript.com/view/o7KF2cBfJR8"
    ],
    "L03_3_SimpleCNN_Augmentation": [
        "",
        "https://share.descript.com/view/oLnDtRlJJg5"
    ],
    "L03_4_Schedulers": [
        "",
        "https://share.descript.com/view/JwgUzWzLlvk"
    ],
    "L03_5_Early_Stopping": [
        "",
        "https://share.descript.com/view/0kFaJKcGgDa"
    ],
    "L04_1_PlainDeepCNN_Overview": [
        "",
        "https://share.descript.com/view/lJDYkYau8Xm"
    ],
    "L04_1_Training_PlainDeepCNN": [
        "",
        "https://share.descript.com/view/hPnxecBQWTX"
    ],
    "L04_1_Batch_Normalization": [
        "",
        "https://share.descript.com/view/wg9ghMlM7MH"
    ],
    "L04_1_Residual_Connections": [
        "",
        "https://share.descript.com/view/4CJ4mOGuJ6q"
    ]
}
...
'''
def play_video(vid_name, width=640, height=360):
    from IPython.display import display, IFrame
    from IPython.core.display import HTML
    
    # Retrieve video URLs
    vid_path_uwex = video_urls[vid_name][0]
    vid_path_descript = video_urls[vid_name][1]
    
    # Create styled HTML for links
    hlink_uwex = f"""
    <div style="background-color: aquamarine; padding: 10px; margin-bottom: 10px;">
        <a href="{vid_path_uwex}" target="_blank" style="text-decoration: none; color: black;">
            Open UWEX version of video in new tab
        </a>
    </div>
    """
    hlink_descript = f"""
    <div style="background-color: aquamarine; padding: 10px; margin-bottom: 10px;">
        <a href="{vid_path_descript}" target="_blank" style="text-decoration: none; color: black;">
            Open Descript version of video in new tab
        </a>
    </div>
    """
    
    # Create styled HTML for iframe
    iframe_html = f"""
    <div style="background-color: aquamarine; padding: 10px; display: inline-block;">
        <iframe src="{vid_path_uwex}" width="{width}" height="{height}" style="border: none;"></iframe>
    </div>
    """
    
    # Display iframe and links
    display(HTML(iframe_html))
    display(HTML(hlink_uwex))
    display(HTML(hlink_descript))
...
def play_video(vid_name, width=640, height=360):
    ...
    vid_path_uwex = video_urls[vid_name][0]
    vid_path_descript = video_urls[vid_name][1]
    hlink_uwex = '<a href = ' + vid_path_uwex + ' target = """_blank""">Open UWEX version of video in new tab</a>'
    hlink_descript = '<a href = ' + vid_path_descript + ' target = """_blank""">Open Descript version of video in new tab</a>'
    display(IFrame(vid_path_uwex, width=width, height=height))
    display(HTML(hlink_uwex))
    display(HTML(hlink_descript))
